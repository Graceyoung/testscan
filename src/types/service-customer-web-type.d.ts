declare namespace serviceType {
    ...
    namespace CheckLoginNameOrPhoneUsingPOST7 {
        namespace Responses {
            export type $200 = serviceType.jiekoutongyifanhuishitiOfboolean;
        }
    }
    /**
     * ContractStatisticsVo
     */
    export interface ContractStatisticsVo {
        /**
         * 即将到期合同数量
         */
        dueCount?: number; // int64
        /**
         * 到期合同数量
         */
        timeOutCount?: number; // int64
        /**
         * 全部数量
         */
    ...
    namespace QueryHctdUserListUsingPOST7 {
        namespace Responses {
    ...
    namespace StatisticsUsingPOST7 {
        namespace Responses {
            export type $200 = serviceType.jiekoutongyifanhuishitiOfContractStatisticsVo;
        }
    }
    ...
    /**
     * 接口统一返回实体OfContractStatisticsVo
     */
    export interface jiekoutongyifanhuishitiOfContractStatisticsVo {
        /**
         * 具体数据对象
         */
        data?: serviceType.ContractStatisticsVo;
        /**
         * 返回消息
         */
        message?: string;
    ...
    export interface kehufujianbiaocustomerFile {
         ...
         */
        type?: {
            name?: "LICENSE" | "ID_CARD_POSITIVE" | "ID_CARD_OTHER_SIDE" | "CONTRACT_FILE" | "MERCHANT_IMG" | "COMMODITY_IMG";
            disName?: string;
        };
        /**
         * 修改人
